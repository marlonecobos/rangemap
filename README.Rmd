...
A version of the package **rangemap** (the result of the project) is in CRAN and can be found <a href="https://cran.r-project.org/web/packages/rangemap/index.html" target="_blank">here</a>.
