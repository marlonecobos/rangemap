...
#'
#' @description rangemap_bound generates a distributional range for a given species
...
#' @param boundary_level (numeric) level of the administrative boundaries (from 0 to 5; 0 is
...
#' @param kept_data (logical) if TRUE and \code{polygons} is not defined, data dowloaded from the GADM data
